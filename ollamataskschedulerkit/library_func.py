...
Bu Yazılımın Bir Kopyası GitHub da yayınlanmaktadır Görüntülemek için: https://github.com/LinuxUsersLinuxMint/OllamaTaskSchedulerKit
A Copy of This Software is published on GitHub To view: https://github.com/LinuxUsersLinuxMint/OllamaTaskSchedulerKit"""

from ollamataskschedulerkit.lib_ver_info import *

def LibAbout():
    print("Python Library Name:", format(PYTHON_LIB_NAME))
    print("Python Library Version:", format(PYTHON_LIB_VER))
    print("Ollama Library Version:", format(OLLAMA_LIB_VER))
